...
def search(phrase, limit=10):
    ...
    print(
        Fore.BLUE + f"found {phrase_hits_count} hits in {document_hits_count} documents"
    )
...
if __name__ == "__main__":
    ...
    q = [inquirer.Text("Search", message="Search")]
    ...
    while next_ != "Exit":
        if "Get key terms" == next_:
            ...
            q = [
                inquirer.Text("num_to_open", message="how many to open?", default="10")
            ]
